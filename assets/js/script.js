...
bookFormIsCompleteCheckbox.addEventListener("change", updateSumitBtn);
...
function loadBooks(book) {
    ...
    toggleButton.addEventListener("click", () => statusBook(book.id));
...
function addBook(event) {
    ...
    document.getElementById("form-title").innerHTML = "Tambah Buku Baru";
    updateSumitBtn();
}
...
function editBook(bookId) {
    ...
    if (book) {
        ...
        document.getElementById("form-title").innerHTML = "Edit Buku";
...
function searchBook(event) {
    ...
    incompleteBookList.innerHTML = "";
    completeBookList.innerHTML = "";
    filteredBooks.forEach((book) => loadBooks(book));
}

function updateSumitBtn() {
    const span = bookFormSubmitButton.querySelector("span");
